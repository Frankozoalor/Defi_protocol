    ...
    */
     export const addLiquidity = async(
      ...
      try{
         // creating a new instance of the token contract
          const tokenContract = new Contract(
              TOKEN_CONTRACT_ADDRESS,
              TOKEN_CONTRACT_ABI,
              signer
          );
        // creating a new instance of the exchange contract
     ...
     */
     export const calculateCD = async(_addEther = "0", etherBalanceContract, cdTokenReserve) => {
        // `_addEther` is a string, so therefore we convert it to a Bignumber before we can do our calculations
